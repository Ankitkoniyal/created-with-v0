  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data.session && data.user) {
        ...
        // Step 2: Use the exact enum values from your database
        const userRole = String(profileData.role || 'user');
        console.log("[DEBUG] User role:", userRole);

        // ✅ UPDATED: Check for the exact enum values
        const isSuperAdmin = userRole === 'super_admin';

        console.log("[DEBUG] Is super admin:", isSuperAdmin);

        // ✅ UPDATED: Use the correct super admin email
        ...
        console.log("[DEBUG] Expected email:", expectedSuperAdminEmail);
        console.log("[DEBUG] Actual email:", data.user.email);
        console.log("[DEBUG] Email match:", data.user.email === expectedSuperAdminEmail);
        console.log("[DEBUG] Is expected super admin:", isExpectedSuperAdmin);

        // ✅ UPDATED: Redirect logic - super_admin goes to superadmin dashboard
