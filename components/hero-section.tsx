...
export function HeroSection() {
  return (
    <section className="relative w-full py-16 px-4 overflow-hidden bg-gray-950">
      ...
      <div className="relative max-w-6xl mx-auto text-center z-10">
        ...
        {/* New, more attractive CTA Button with bounce */}
        <button className="bg-gradient-to-r from-green-500 to-green-600 text-white font-bold py-4 px-12 rounded-full text-xl shadow-2xl hover:shadow-green-500/50 transition-all duration-300 transform hover:scale-105 animate-bounce-slow mb-16">
          <span className="relative">Post Free Ads Now!</span>
        </button>

        {/* Feature Sections with more space */}
        <div className="grid grid-cols-1 md:grid-cols-3 justify-center items-center gap-8 max-w-4xl mx-auto mb-12">
