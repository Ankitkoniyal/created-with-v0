...
export function MegaMenu({ onCategorySelect }: MegaMenuProps) {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto bg-white shadow-lg rounded-lg border">
      <div className="border-b border-gray-100 bg-gradient-to-r from-green-50 to-green-100 p-4">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          ...
          {["Cars", "Mobile Phones", "Apartments", "Jobs", "Electronics", "Fashion"].map((popular) => (
            <Link
              ...
              className="text-sm text-green-700 hover:text-green-800 hover:underline bg-white px-2 py-1 rounded border border-green-100 hover:border-green-200 transition-colors"
